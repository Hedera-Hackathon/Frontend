...
export const projectAbi = [
  ...
  },
  {
    ...
    outputs: [
      { name: 'benAddress', internalType: 'address[]', type: 'address[]' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      { name: 'vendors', internalType: 'address[]', type: 'address[]' },
    ],
    stateMutability: 'view',
  },
  {
 ...
 */
export const useReadProjectGetProjectVendor =
  /*#__PURE__*/ createUseReadContract({
    abi: projectAbi,
 ...
 */
export const useWriteProjectAddBeneficiary =
 ...
 */
export const useWriteProjectCreateProject =
  /*#__PURE__*/ createUseWriteContract({
    abi: projectAbi,
 ...
 */
export const useSimulateProjectAddBeneficiary =
 ...
 */
export const useSimulateProjectAddVendor =
  /*#__PURE__*/ createUseSimulateContract({
    abi: projectAbi,
    functionName: 'addVendor',
  })
 ...
 */
export const useSimulateProjectCreateProject =
  /*#__PURE__*/ createUseSimulateContract({
    abi: projectAbi,
    functionName: 'createProject',
  })
 ...
 */
export const useWatchProjectBeneficiaryAddedEvent =
 ...
 */
export const useWatchProjectProjectCreatedEvent =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: projectAbi,
 ...
 */
export const useWatchProjectTransferToVendorEvent =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: projectAbi,
 ...
 */
export const useWatchProjectVendorAddedEvent =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: projectAbi,
